...
let noimg, danceimg, nookimg, singimg, okimg, fightimg, flyimg, notalkimg, hideimg, talkimg, showimg, nobookimg, bookimg, nohelpimg, helpimg, meimg, yourselfimg, himimg, cryimg, galleryimg, balletimg, musicimg, apimg, artimg, noAPLITimg, nothanksimg, APLITimg, cloneimg;
let fa, fr, so, se;
let dot = [];
...
function preload() {
  ...
  noAPLITimg = loadImage('noAPLIT.png');
  nothanksimg = loadImage('nothanks.png');
  APLITimg = loadImage('APLIT.png');
  cloneimg = loadImage('clone.png');
}
...
function draw() {
  ...
  if (scene == 35 && mouseIsPressed && se == 0) {
    scene = 102;
    mouseIsPressed = false;
  }
  ...
  if (scene == 37 && mouseIsPressed && se == 0) {
    scene = 102;
    mouseIsPressed = false;
  }
  ...
  if (scene == 40 && mouseIsPressed) {
    scene = 105;
    mouseIsPressed = false;
  }
  if (scene == 41 && mouseIsPressed) {
    scene = 105;
    mouseIsPressed = false;
  }
  if (scene == 34 && mouseIsPressed) {
    scene = 105;
    mouseIsPressed = false;
  }
  if (scene == 35 && mouseIsPressed) {
    scene = 105;
    mouseIsPressed = false;
  }
  if (scene == 101 && mouseIsPressed) {
    scene = 1;
    mouseIsPressed = false;
  }
  if (scene == 102 && mouseIsPressed) {
    scene = 1;
    mouseIsPressed = false;
  }
  if (scene == 103 && mouseIsPressed) {
    scene = 1;
    mouseIsPressed = false;
  }
  if (scene == 104 && mouseIsPressed) {
    scene = 1;
    mouseIsPressed = false;
  }
  if (scene == 105 && mouseIsPressed) {
    scene = 1;
    mouseIsPressed = false;
  }
...
function scene26() {
  ...
  square(200, 200, 200);
  square(400, 200, 200);
  text("Your next school year's focus.", 160, 60);
  if (mouseX < 300) {
    fill(255, 203, 125);
    square(200, 200, 220);
    fill(255, 170, 51);
...
function scene29() {
  fill(0, 0, 255);
  text("You saw other people's performance went well.", 100, 200);
  if (fa == 100 && se == 65 && fr == 60 && so == 30) {
    fa = 100;
    se = 55;
    fr = 70;
...
function scene101() {
  ...
  text("You are granted for rebirth.", 150, 360 - 40);
  text("But, you don't know who you will become", 100, 390 - 40);
  text("CLICK TO RESTART", 180, 50);
}

function scene102() {
  text("You have lost your self-esteem.", 130, 210 - 40);
  text("You think you are useless, and the worst", 90, 240 - 40);
  text("One day, you jumped off the train", 140, 270 - 40);
  text("at the age of 21.", 220, 300 - 40);
  text("You are granted for rebirth.", 150, 330 - 40);
  text("But, you don't know who you will become", 100, 360 - 40);
  text("CLICK TO RESTART", 180, 50);
}
...
function scene105() {
  fill(255);
  text("You have a good life.", 180, 210 - 40);
  text("At the age of 21, you were killed in a car accident.", 40, 240 - 40);
  text("You family and friends grieved over your death", 70, 270 - 40);
  text("You are granted for rebirth.", 150, 300 - 40);
  text("But, you don't know who you will become", 100, 330 - 40);
  text("CLICK TO RESTART", 180, 50);
